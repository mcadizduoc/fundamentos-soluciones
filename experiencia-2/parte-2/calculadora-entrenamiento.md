...
Y también al momento de solicitar si el usuario desea calcular cuantos días requeriría para alcanzar el peso ideal:
...
### While para repetir la soliciutd de la información 

Si hay errores al ingresar la información, sería ideal mantener el software corriendo para asegurarnos que su ejecución sea correcta. Lo haremos para la primera información ingresada:
...
Y finalmente para la opción de si desea calcular los días para alcanzar el peso ideal:
...
# Ahora consolidamos todo

Implementando todas estas partes nos queda finalmente el código definitivo y ya pudimos implementar todas lo aprendido en la experiencia.
