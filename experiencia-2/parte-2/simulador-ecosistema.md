## Resolución ejercicio simulador de ecosistema con eventos climáticos

En este documento encontrarán un paso a paso de cómo resolver el problema del "simulador de ecosistema con eventos climáticos". Iré explicando paso a paso cómo construir la solución.

Para resolver este ejercicio, primero necesitamos entender qué información vamos a utilizar en nuestra simulación: la población de herbívoros (conejos), la población de depredadores (zorros), la cantidad de vegetación y la condición climática. Además, debemos definir cómo interactúan entre sí estas variables y cómo cambian con el tiempo.

### Inicialización de variables y solicitud de datos al usuario

Primero, solicitamos al usuario que ingrese los valores iniciales para nuestra simulación:
...
### Definir constantes y parámetros del ecosistema

Ahora, necesitamos definir algunos parámetros que controlarán el comportamiento de nuestro ecosistema:
...
Ya con los parámetros definidos, podemos iniciar la simulación:
...
Ya finalmente nos toca reunir todas las piezas en una sola pieza de código
